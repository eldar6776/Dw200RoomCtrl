...
mainView.init = function () {
    ...
    let screen_label_company = buildLabel('screen_label_company', date_box, 27, "Welcome")
    mainView.screen_label_company = screen_label_company
    screen_label_company.width(220);
    screen_label_company.longMode(dxui.Utils.LABEL_LONG_MODE.SCROLL_CIRCULAR)
    // /**************************************************Create Meeting Label*****************************************************/
    // let meeting_label = buildLabel('meeting_label', screen_main, 60, "In Meeting")
    ...
    let screen_btn_unlocking_label = buildLabel('screen_btn_unlocking_label', screen_btn_unlocking, 30, "Password")
